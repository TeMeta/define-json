...
_A specific time period in a known system of time periods that identifies the end period of a report._





URI: [odm:reportingEnd](https://cdisc.org/odm2/reportingEnd)
Alias: reportingEnd
