...
URI: [odm:IsODMItem](https://cdisc.org/odm2/IsODMItem)
...
| ---  | --- | --- | --- |
| [role](role.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | Identifies the role of the item within the containing context, taken from the... | direct |
| [roleCodeList](roleCodeList.md) | 0..1 <br/> [CodeList](CodeList.md) | Reference to the CodeList that defines the roles for this item | direct |
| [hasNoData](hasNoData.md) | 0..1 <br/> [Boolean](Boolean.md) | Set to Yes if this is a manifest and there is no data for this item | direct |
| [crfCompletionInstructions](crfCompletionInstructions.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | CRFCompletionInstructions reference: Instructions for the clinical site on ho... | direct |
| [cdiscNotes](cdiscNotes.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | CDISCNotes reference: Explanatory text for the variable | direct |
| [implementationNotes](implementationNotes.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | ImplementationNotes reference: Further information, such as rationale and imp... | direct |
| [collectionExceptionCondition](collectionExceptionCondition.md) | 0..1 <br/> [Condition](Condition.md) | Condition that defines when collection may be exempted | direct |
| [preSpecifiedValue](preSpecifiedValue.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | Prefill value or a default value for a field that is automatically populated | direct |
