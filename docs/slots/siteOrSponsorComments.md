...
URI: [dds:slot/siteOrSponsorComments](https://w3id.org/dds/slot/siteOrSponsorComments)
...
* Range: [SiteOrSponsorComment](../classes/SiteOrSponsorComment.md)
