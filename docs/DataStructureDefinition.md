...
URI: [odm:DataStructureDefinition](https://cdisc.org/odm2/DataStructureDefinition)
...
| [measures](measures.md) | * <br/> [Measure](Measure.md) |  | direct |
| [attributes](attributes.md) | * <br/> [DataAttribute](DataAttribute.md) |  | direct |
| [grouping](grouping.md) | 0..1 <br/> [ComponentList](ComponentList.md) | An association to a set of metadata concepts that have an identified structur... | direct |
| [evolvingStructure](evolvingStructure.md) | 0..1 <br/> [Boolean](Boolean.md) |  | direct |
| [domain](domain.md) | 0..1 <br/> [String](String.md) | Domain abbreviation for the dataset | [ItemGroup](ItemGroup.md) |
| [structure](structure.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[String](String.md)&nbsp;or&nbsp;<br />[TranslatedText](TranslatedText.md) | Data structure of the item group, indicating how the records are organized | [ItemGroup](ItemGroup.md) |
| [isReferenceData](isReferenceData.md) | 0..1 <br/> [Boolean](Boolean.md) | Set to Yes if this is a reference item group | [ItemGroup](ItemGroup.md) |
| [type](type.md) | 0..1 <br/> [ItemGroupType](ItemGroupType.md) | Type of item group | [ItemGroup](ItemGroup.md) |
| [items](items.md) | * <br/> [Item](Item.md) | Items in this group | [ItemGroup](ItemGroup.md) |
| [children](children.md) | * <br/> [ItemGroup](ItemGroup.md) | Child item groups within this item group | [ItemGroup](ItemGroup.md) |
| [implementsConcept](implementsConcept.md) | 0..1 <br/> [ReifiedConcept](ReifiedConcept.md) | Reference to a abstract concept topic that this item group is a specializatio... | [ItemGroup](ItemGroup.md) |
| [whereClause](whereClause.md) | 0..1 <br/> [WhereClause](WhereClause.md) | If nested in a parent ItemGroup context, conditions for when this group appli... | [ItemGroup](ItemGroup.md) |
...
| ---  | --- | --- | --- |
| [Dataflow](Dataflow.md) | [structure](structure.md) | range | [DataStructureDefinition](DataStructureDefinition.md) |
| [Dataset](Dataset.md) | [structuredBy](structuredBy.md) | range | [DataStructureDefinition](DataStructureDefinition.md) |
| [Distribution](Distribution.md) | [conformsTo](conformsTo.md) | any_of[range] | [DataStructureDefinition](DataStructureDefinition.md) |
