...
URI: [odm:Dataset](https://cdisc.org/odm2/Dataset)
...
* [IdentifiableElement](IdentifiableElement.md) [ [Identifiable](Identifiable.md) [Labelled](Labelled.md)]
    * **Dataset** [ [Versioned](Versioned.md) [IsProfile](IsProfile.md) [IsSdmxDataset](IsSdmxDataset.md)]
...
| ---  | --- | --- | --- |
| [describedBy](describedBy.md) | 0..1 <br/> [Dataflow](Dataflow.md) | Associates a Dataflow and thereby a Data Structure Definition to the data set | direct |
| [structuredBy](structuredBy.md) | 0..1 <br/> [DataStructureDefinition](DataStructureDefinition.md) | Associates the Data Structure Definition that defines the structure of the Da... | direct |
| [publishedBy](publishedBy.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[Organization](Organization.md)&nbsp;or&nbsp;<br />[String](String.md) | Associates the Data Provider that reports/publishes the data | direct |
| [keys](keys.md) | 1..* <br/> [String](String.md)&nbsp;or&nbsp;<br />[SeriesKey](SeriesKey.md)&nbsp;or&nbsp;<br />[GroupKey](GroupKey.md) | Series and Group keys in the data that are associated with dimensions in this... | direct |
| [datasetType](datasetType.md) | 0..1 <br/> [String](String.md) | Type or classification of the dataset | direct |
| [distribution](distribution.md) | * <br/> [Distribution](Distribution.md) | Representations of this dataset in various formats or access methods | direct |
| [conformsTo](conformsTo.md) | 0..1 <br/> [String](String.md) | Specification or standard that this dataset conforms to | direct |
| [hasPolicy](hasPolicy.md) | * <br/> [String](String.md) | Access or usage policy applied to this dataset | direct |
| [informationSensitivityClassification](informationSensitivityClassification.md) | 0..1 <br/> [String](String.md) | Classification of the dataset's sensitivity or confidentiality | direct |
...
| [action](action.md) | 0..1 <br/> [String](String.md) | Defines the action to be taken by the recipient system (information, append, ... | [IsSdmxDataset](IsSdmxDataset.md) |
| [reportingBegin](reportingBegin.md) | 0..1 <br/> [String](String.md) | A specific time period in a known system of time periods that identifies the ... | [IsSdmxDataset](IsSdmxDataset.md) |
| [reportingEnd](reportingEnd.md) | 0..1 <br/> [String](String.md) | A specific time period in a known system of time periods that identifies the ... | [IsSdmxDataset](IsSdmxDataset.md) |
| [dataExtractionDate](dataExtractionDate.md) | 0..1 <br/> [String](String.md) | A specific time period that identifies the date and time that the data are ex... | [IsSdmxDataset](IsSdmxDataset.md) |
| [validFrom](validFrom.md) | 0..1 <br/> [String](String.md) | Indicates the inclusive start time indicating the validity of the information... | [IsSdmxDataset](IsSdmxDataset.md) |
| [validTo](validTo.md) | 0..1 <br/> [String](String.md) | Indicates the inclusive end time indicating the validity of the information i... | [IsSdmxDataset](IsSdmxDataset.md) |
| [publicationYear](publicationYear.md) | 0..1 <br/> [String](String.md) | Specifies the year of publication of the data or metadata in terms of whateve... | [IsSdmxDataset](IsSdmxDataset.md) |
| [publicationPeriod](publicationPeriod.md) | 0..1 <br/> [String](String.md) | Specifies the period of publication of the data or metadata in terms of whate... | [IsSdmxDataset](IsSdmxDataset.md) |
...
| ---  | --- | --- | --- |
| [DataProduct](DataProduct.md) | [inputDataset](inputDataset.md) | range | [Dataset](Dataset.md) |
| [DataProduct](DataProduct.md) | [outputDataset](outputDataset.md) | range | [Dataset](Dataset.md) |
| [Distribution](Distribution.md) | [isDistributionOf](isDistributionOf.md) | range | [Dataset](Dataset.md) |
