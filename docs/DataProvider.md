...
URI: [odm:DataProvider](https://cdisc.org/odm2/DataProvider)
...
| ---  | --- | --- | --- |
| [providesDataFor](providesDataFor.md) | * <br/> [Dataflow](Dataflow.md) | The Dataflows that this provider supplies data for | direct |
| [provisionAgreements](provisionAgreements.md) | * <br/> [ProvisionAgreement](ProvisionAgreement.md) | The ProvisionAgreements that this provider has with Data Consumers | direct |
| [source](source.md) | * <br/> [Resource](Resource.md) | Association to a data source | direct |
| [role](role.md) | 0..1 <br/> [String](String.md) | The role of the organization in the study | [Organization](Organization.md) |
| [type](type.md) | 0..1 <br/> [OrganizationType](OrganizationType.md) | The type of organization (e | [Organization](Organization.md) |
| [location](location.md) | 0..1 <br/> [String](String.md) | The physical location of the organization | [Organization](Organization.md) |
| [address](address.md) | 0..1 <br/> [String](String.md) | The address of the organization | [Organization](Organization.md) |
| [partOfOrganization](partOfOrganization.md) | 0..1 <br/> [Organization](Organization.md) | Reference to a parent organization if this organization is part of a larger e... | [Organization](Organization.md) |
...
| ---  | --- | --- | --- |
| [ProvisionAgreement](ProvisionAgreement.md) | [provider](provider.md) | range | [DataProvider](DataProvider.md) |
