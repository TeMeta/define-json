...
URI: [odm:Formatted](https://cdisc.org/odm2/Formatted)
...
| ---  | --- | --- | --- |
| [decimalDigits](decimalDigits.md) | 0..1 <br/> [Integer](Integer.md) | For decimal values, the number of digits after the decimal point | direct |
| [displayFormat](displayFormat.md) | 0..1 <br/> [String](String.md) | A display format for the item | direct |
| [significantDigits](significantDigits.md) | 0..1 <br/> [Integer](Integer.md) | For numeric values, the number of significant digits | direct |
