"""
Command-line interface for Data Definition Specification converters.
...
from ..validation.schema import validate_data_definition_spec


def create_cli_parser() -> argparse.ArgumentParser:
    """Create the command-line argument parser."""
    parser = argparse.ArgumentParser(
        description="Data Definition Specification: Bidirectional XML ↔ JSON converter for clinical data",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Convert XML to JSON (strict mode, default)
  data-definition-spec xml2json define.xml output.json
  
  # Convert XML to JSON with inference enabled
  data-definition-spec xml2json define.xml output.json --enable-inference
  
  # Convert JSON to XML  
  data-definition-spec json2xml define.json output.xml
  
  # Convert JSON to XML with custom stylesheet
  data-definition-spec json2xml define.json output.xml --stylesheet ./my-style.xsl
  
  # Convert JSON to HTML (no CORS issues!)
  data-definition-spec json2html define.json output.html
  
  # Convert XML to HTML (no CORS issues!)
  data-definition-spec xml2html define.xml output.html
  
  # Run roundtrip test
  data-definition-spec roundtrip define.xml define.json
  
  # Validate JSON schema
  data-definition-spec validate define.json
        """
    )
    ...
    xml2json_parser = subparsers.add_parser('xml2json', help='Convert Define-XML to Data Definition Specification')
    xml2json_parser.add_argument('input', type=Path, help='Input Define-XML file')
    xml2json_parser.add_argument('output', type=Path, help='Output Data Definition Specification file')
    ...
    json2xml_parser = subparsers.add_parser('json2xml', help='Convert Data Definition Specification to Define-XML')
    json2xml_parser.add_argument('input', type=Path, help='Input Data Definition Specification file')
    ...
    json2html_parser = subparsers.add_parser('json2html', help='Convert Data Definition Specification to HTML using XSL transformation')
    json2html_parser.add_argument('input', type=Path, help='Input Data Definition Specification file')
    ...
    roundtrip_parser.add_argument('json_file', type=Path, help='Data Definition Specification file')
    ...
    # Schema validation
    validate_parser = subparsers.add_parser('validate', help='Validate Data Definition Specification schema')
    validate_parser.add_argument('input', type=Path, help='Data Definition Specification file to validate')
...
def cmd_validate(args) -> int:
    """Validate Data Definition Specification schema."""
    try:
        import json
        ...
        results = validate_data_definition_spec(data)
