"""
Roundtrip validation for Define-XML ↔ Data Definition Specification conversion.
...
def run_roundtrip_test(original_xml_path: Path, converted_json_path: Path) -> Dict[str, Any]:
    ...
    Args:
        original_xml_path: Path to the original Define-XML file
        converted_json_path: Path to the converted Data Definition Specification file
