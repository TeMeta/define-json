"""
HTML Generation companion module for Data Definition Specification to Define-XML converter.
...
Example usage:
    ...
    # Convert Data Definition Specification directly to HTML
...
class DefineHTMLGenerator:
    ...
    def json_to_html(self, 
        ...
        """
        Convert Data Definition Specification to HTML using the high-fidelity converter
        followed by XSL transformation.
        
        Args:
            json_path: Path to input Data Definition Specification file
    ...
    def generate_preview(self, 
        ...
        """
        Generate a quick HTML preview of Data Definition Specification content.
        
        This method creates a simplified HTML view without requiring XSL transformation,
        useful for quick validation and review.
        
        Args:
            json_path: Path to Data Definition Specification file
        ...
        html_parts = [
            ...
            '<head>',
            '<meta charset="utf-8">',
            '<title>Data Definition Specification Preview</title>',
            '<style>',
            ...
            '</head>',
            '<body>',
            '<h1>Data Definition Specification Preview</h1>',
        ]
    ...
    def batch_convert(self, 
        ...
        """
        Batch convert multiple Data Definition Specification files to HTML.
        
        Args:
            input_dir: Directory containing Data Definition Specification files
