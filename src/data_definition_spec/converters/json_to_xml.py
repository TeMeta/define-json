"""
Data Definition Specification to Define-XML converter - Unified Smart Converter.
...
class DefineJSONToXMLConverter:
    """
    Convert Data Definition Specification to Define-XML with intelligent structure handling.
    ...
    def convert_file(self, json_path: Path, output_path: Path) -> ET.Element:
        """
        Convert Data Definition Specification file to Define-XML.
    ...
    def _add_range_checks(self, wc_elem: ET.Element, condition: Dict[str, Any]) -> None:
        ...
        for range_check_data in condition.get('rangeChecks', []):
            ...
            # Add CheckValue child elements (Data Definition Specification stores as checkValues list)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Convert Data Definition Specification to Define-XML')
    parser.add_argument('input', help='Input Data Definition Specification file')
