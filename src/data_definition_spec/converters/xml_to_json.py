"""
Improved Define-XML to Data Definition Specification converter with proper Pydantic validation.
...
class DefineXMLToJSONConverter:
    ...
    def convert_file(self, xml_path: Path, output_path: Path) -> Dict[str, Any]:
        """Convert Define-XML file to Pydantic-validated Data Definition Specification."""
    ...
    def _parse_datetime(self, dt_str: Optional[str]) -> datetime:
        ...
        Auto-generates current datetime if None to ensure valid Data Definition Specification.
        """
        if not dt_str:
            ...
            for rc in wc_elem.findall('.//odm:RangeCheck', self.active_namespaces):
                ...
                if comparator and item_oid:
                    range_check_data = {
                        ...
                        'item': item_oid,  # Use 'item' to match Data Definition Specification schema
                    }
                    # Use checkValues (plural) list to match Data Definition Specification schema
                    if check_values:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Convert Define-XML to Data Definition Specification',
...
Examples:
  ...
  python xml_to_json.py input.xml output.json --preserve-original
    ...
    parser.add_argument('output', help='Output Data Definition Specification file')
    parser.add_argument(
        '--infer', 
        action='store_true',
